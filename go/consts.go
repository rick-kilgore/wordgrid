...
// 10th solo challenge board
var board10 = BoardSpec{
	SOLO_WIDTH, SOLO_HEIGHT, []RowSpec{
		{0: TW, 1: DL, 5: DL, 9: DL, 10: TW},
		{0: DL, 1: DW, 2: DL, 4: DL, 5: TL, 6: DL, 8: DL, 9: DW, 10: DL},
		{1: DL, 2: TL, 5: DL, 8: TL, 9: DL},
		{3: DL, 5: UK, 7: DL},
		{0: DL, 1: DL, 4: DL, 5: UK, 6: DL, 9: DL, 10: DL},
		{1: TL, 2: DL, 8: DL, 9: TL},
	},
}
